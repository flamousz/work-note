      ...
      <div class="relative w-full max-w-2xl bg-neutral-900 border border-neutral-800 rounded-xl shadow-2xl overflow-hidden transform transition-all duration-350 z-10">
        ...
        <form @submit.prevent="save" class="p-6 space-y-4 max-h-[80vh] overflow-y-auto">
          ...
          <div class="space-y-1.5">
            <label class="text-xs font-semibold text-neutral-400">Nama Pekerjaan / Submodul <span class="text-violet-400">*</span></label>
            <input
              v-model="name"
              type="text"
              required
          ...
          <div v-if="activeTab === 'logtask' && isEdit" class="space-y-1.5">
            <TaskChecklist :submodule-id="submodule.id" :readonly="isReadMode" />
          </div>
